...
const STOP_BUTTON_TEXTS = {
  ...
  ariaLabel: { es: "Detener la ronda", en: "Stop the round", fr: "Arrêter la manche", pt: "Parar a rodada" },
};

export function StopButton({ onClick, disabled, language }: StopButtonProps) {
